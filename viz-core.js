/* ==========================================================================
   ...
   Used by the section 2.4 learning labs:
     - Go Concurrency Lab: a discrete-event model of a producer / buffered
       channel / worker-pool pattern. 1 tick == 100 ms of simulated time.
     - BST Lab: Binary Search Tree with every comparison recorded as a step.

   Everything here is a browser-based educational simulation written in
   JavaScript. It does NOT execute Go code, does not connect to any backend,
   and no real goroutines, channels or workers are running.
   Loaded by the browser as window.VizCore (module.exports for Node tests).
   ========================================================================== */
(function (root) {
  'use strict';
  ...
  /* ------------------------------------------------------------------------
     Presets (Concurrency Lab scenarios)
     ------------------------------------------------------------------------ */
  const PRESETS = {
